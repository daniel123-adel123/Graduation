                  ...
                  Container(
                    ...
                    child: Card(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          _buildDetailRow(S.of(context).Name, Icons.person,
                              widget.donar.donarName),
                          Divider(),
                          _buildDetailRow(
                          ...
                          _buildDetailRow(S.of(context).Blood_type,
                              Icons.favorite, widget.donar.bloodType),
                          Divider(),
                          _buildDetailRow(S.of(context).Blood_Type_Date,
                              Icons.calendar_today, widget.donar.createdDate),
                          Divider(),
                          _buildDetailRow(S.of(context).Blood_Type_Expiry_Date,
                              Icons.timer, widget.donar.expiredDate),
                          Divider(),
                          _buildDetailRow(S.of(context).More_Details,
                              Icons.info, widget.donar.moreDetails),
                          Divider(),
                        ],
                      ),
                    ),
