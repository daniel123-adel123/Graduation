...
class _HospitalDashboardState extends State<HospitalDashboard> {
  ...
  Widget build(BuildContext context) {
    final List<serviceData> list = [
      serviceData('Assets/Images/scan.png', S.of(context).create_Qr),
      serviceData('Assets/Images/search (3).png', S.of(context).search),
      serviceData('Assets/Images/add (1).png', S.of(context).Add),
      serviceData('Assets/Images/remove.png', S.of(context).Remove),
      serviceData('Assets/Images/check.png', S.of(context).Check_Donor),
      serviceData('Assets/Images/info0.png', S.of(context).Info),
    ];
